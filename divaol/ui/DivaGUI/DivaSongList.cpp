#include "ui/DivaGUI/DivaSongList.h"
#include "ui/roomUI.h"
...
namespace diva
{
	...
	{
		UIScreenRoom::Instance()->slider->setMarkPosition(v);
	}
	...
	void DivaSongList::itemChanged()
	{
		...
		if (t < 0)
			t = 0;
		UIScreenRoom::Instance()->slider->setMarkScale(0, t, getItemCount());
	}

	void DivaSongList::highlightItemChanged(int index)
	{
		UIScreenRoom::Instance()->SongListHighlightItemChanged(index);
	}
