#ifndef DivaEditorSlider_H
#define DivaEditorSlider_H
...
namespace gcn
{
     ...
     */
    class GCN_CORE_DECLSPEC DivaEditorSlider :
        public Widget,
    ...
    public:
         ...
         */
        DivaEditorSlider(double scaleEnd = 1.0);
         ...
         * @param scaleEnd The end value of the slider scale.
         */
        DivaEditorSlider(double scaleStart, double scaleEnd);

        /**
         * Destructor.
         */
        virtual ~DivaEditorSlider() { }
